...
**v0.0.2.1 Focus:** Configuration ownership, precedence, validation, immutable/runtime state, secrets, profiles and change control  
...
**Configuration ownership, precedence, validation, immutable/runtime state, secrets, profiles, model/runtime configuration and change control.**
