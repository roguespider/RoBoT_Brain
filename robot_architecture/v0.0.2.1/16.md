...
**v0.0.2.1 Focus:** Retrieval stages, candidate generation, ranking, confidence, provenance, diversity, budget and failure handling  
...
**Candidate generation, ranking, confidence, provenance, diversity, budget, freshness, failure handling and retrieval traceability.**
