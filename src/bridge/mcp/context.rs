...
impl McpContext {
    pub fn new(
        systems: crate::bridge::app::initialization::mcp_context::McpContextSystems,
    ) -> Self {
        let crate::bridge::app::initialization::mcp_context::McpContextSystems {
            database,
            job_queue,
            bus,
            coordinator,
            ...
            working_memory_core: working_memory,
            permanent_memory,
            memory_retrieval,
            workflow_engine,
            ...
            acp_router,
            acp_registry,
            shared_personality: personality,
            world_model,
            enforcer,
        } = systems;
