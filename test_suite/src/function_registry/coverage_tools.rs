...
pub fn coverage_tools() -> Vec<TestRequirement> {
    vec![
        ...
        req(
            "cov_get_related_knowledge",
            "get_related_knowledge",
            false,
            2,
        ),
        req(
            "cov_validate_knowledge_deps",
            "validate_knowledge_dependencies",
            false,
            2,
        ),
        req(
            "cov_bump_knowledge_version",
        ...
        // Reflection
        req(
            "cov_list_reflections_by_status",
        ...
        req(
            "cov_set_personality_traits",
            "set_personality_traits",
            false,
            2,
        ),
        req(
            "cov_apply_personality_preset",
            "apply_personality_preset",
            false,
            2,
        ),
        req(
            "cov_list_personality_presets",
            "list_personality_presets",
            false,
            2,
        ),
        req(
            "cov_get_personality_decision",
        ...
        req(
            "cov_add_world_relationship",
            "add_world_relationship",
            true,
            2,
        ),
        req(
            "cov_get_world_relationships",
        ...
        req(
            "cov_get_world_dependencies",
            "get_world_dependencies",
            false,
            2,
        ),
        req(
            "cov_get_world_model_stats",
            "get_world_model_stats",
            false,
            2,
        ),
        req(
            "cov_get_consumed_resources",
